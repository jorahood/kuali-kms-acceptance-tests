...
Given a document with filename "xxxx.dita" exists with content
"""
<?xml version="1.0" encoding="utf-8"?>
&lt|DOCTYPE topic PUBLIC "-//OASIS//DTD DITA Topic//EN" "http://docs.oasis-open.org/dita/v1.1/OS/dtd/topic.dtd">
...
"""
And a document with filename "xxxx.ditamap" exists with content
"""
<?xml version="1.0" encoding="UTF-8"?>
&lt|DOCTYPE map PUBLIC "-//OASIS//DTD DITA Map//EN" "http://docs.oasis-open.org/dita/v1.2/os/dtd1.2/technicalContent/dtd/map.dtd">
<map>
    <topicref keys="" href=".dita#kbdoc"></topicref>
    <reltable>
        <relheader>
...
Then I should see "Tips on buying groceries." in the popup window
